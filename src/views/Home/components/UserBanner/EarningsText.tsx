...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and SPY pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and SPY pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from SPY pool', data)
  }
